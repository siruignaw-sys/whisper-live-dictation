...
Built to use Whisper `large-v3` for high accuracy (including mixed Chinese/English speech and technical vocabulary), while still feeling responsive, by transcribing sentence-by-sentence instead of all at once. 
